...
class LeastRecentlyUsedCacheTest {
    ...
    @InjectMocks
    private CacheBase<Integer, String> cache = new LeastRecentlyUsedCache<>(storageMock, 5);
    ...
    @Test
    void testEvictFromCacheWithThreeElements() {
        cache.put(1, "a");
        cache.put(2, "b");
        cache.put(3, "c");
    ...
    @Test
    void testAddToCacheWithSevenElementsWhileCapacityIsFive() {
        cache.addToCache(1, "a");
